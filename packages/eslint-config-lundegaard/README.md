...
```sh
yarn add -D eslint-config-lundegaard @babel/eslint-parser@7.15.0 @babel/eslint-plugin@7.14.5 eslint@7.32.0 eslint-plugin-import@2.23.4 eslint-plugin-react@7.24.0 eslint-plugin-jest@^24.4.0 eslint-plugin-jest-formatting@^3.0.0
```

or
```sh
npm install eslint-config-lundegaard @babel/eslint-parser@7.15.0 @babel/eslint-plugin@7.14.5 eslint@7.32.0 eslint-plugin-import@2.23.4 eslint-plugin-react@7.24.0 eslint-plugin-jest@^24.4.0 eslint-plugin-jest-formatting@^3.0.0 --save-dev
```
